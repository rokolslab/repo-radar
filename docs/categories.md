...
Категории создаются по мере появления проектов. Один репозиторий хранится только в одной основной категории; остальные характеристики указываются тегами внутри карточки.
